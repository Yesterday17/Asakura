...
<head>
    ...
    <link type="text/css" media="all"
          href="https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/static/css/basic/404_lib.css"
          rel="stylesheet"/>
    <?php wp_head(); ?>
    <script>
...
<section class="error-404 not-found">
    ...
    <div class="err-button back">
        <a id="golast"
           href=javascript:history.go(-1);><?php _e('return to previous page', SAKURA_DOMAIN);/*返回上一页*/ ?></a>
        <a id="gohome" href="<?php bloginfo('url'); ?>"><?php _e('return to home page', SAKURA_DOMAIN);/*返回主页*/ ?></a>
    </div>
    <div style="display:block; width:284px;margin: auto;">
        <p style="margin-bottom: 1em;margin-top: 1.5em;text-align: center;font-size: 15px;"><?php _e('Don\'t worry, search in site?', SAKURA_DOMAIN);/*别急，试试站内搜索？*/ ?></p>
...
<script src="https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/static/js/basic/404.min.js"
