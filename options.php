...
function optionsframework_options() {
    // 测试数据
    $test_array = array(
        'one'   => __('1', SAKURA_DOMAIN), 'two' => __('2', SAKURA_DOMAIN), 'three' => __('3', SAKURA_DOMAIN),
        'four'  => __('4', SAKURA_DOMAIN), 'five' => __('5', SAKURA_DOMAIN), 'six' => __('6', SAKURA_DOMAIN),
    ...
    $multicheck_array = array(
        'one'  => __('1', SAKURA_DOMAIN), 'two' => __('2', SAKURA_DOMAIN), 'three' => __('3', SAKURA_DOMAIN),
        'four' => __('4', SAKURA_DOMAIN), 'five' => __('5', SAKURA_DOMAIN),
    );
    ...
    $background_defaults = array(
        'color'  => '', 'image' => 'https://view.moezx.cc/images/2018/12/23/knights-of-the-frozen-throne-8k-qa.jpg',
        'repeat' => 'repeat', 'position' => 'top center', 'attachment' => 'scroll'
    );
    ...
    $typography_options = array(
        ...
        'styles' => array('normal' => '普通', 'bold' => '粗体'), 'color' => false,
    );
    ...
    $options[] = array(
        'name'    => __('Basic-Setting', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_basic',
        'std'     => 'tag', 'type' => "images",
        'options' => array('tag' => 'https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/setting/basic.png',),
    );

    $options[] = array(
        'name'    => __('Support For You', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_sfu',
        'std'     => 'tag', 'type' => "images",
        'options' => array('tag' => 'https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/setting/support.png',),
    );

    $options[] = array(
        'name' => __('Site Title', SAKURA_DOMAIN), 'desc' => __('Fuukei\'s Blog', SAKURA_DOMAIN), 'id' => 'site_name',
        'std'  => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Author', SAKURA_DOMAIN), 'desc' => __('Fuukei', SAKURA_DOMAIN), 'id' => 'author_name',
        'std'  => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Personal Avatar', SAKURA_DOMAIN), 'desc' => __('The best size is 130px*130px.', SAKURA_DOMAIN),
        'id'   => 'focus_logo', 'type' => 'upload'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'focus_logo_text', 'std' => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Logo', SAKURA_DOMAIN), 'desc' => __('The best height size is 40px。', SAKURA_DOMAIN),
        'id'   => 'akina_logo', 'type' => 'upload'
    );

    $options[] = array(
        'name' => __('Favicon', SAKURA_DOMAIN),
        'desc' => __('It is the small logo on the browser tab, fill in the url', SAKURA_DOMAIN), 'id' => 'favicon_link',
    ...
    $options[] = array(
        ...
        'desc' => __('Customize keywords and descriptions after opening', SAKURA_DOMAIN), 'id' => 'akina_meta',
        'std'  => '0', 'type' => 'checkbox'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'akina_meta_keywords', 'std' => '', 'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'akina_meta_description', 'std' => '', 'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'shownav', 'std' => '1', 'type' => 'checkbox'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'patternimg', 'std' => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name'    => __('Search Button', SAKURA_DOMAIN), 'id' => 'top_search', 'std' => "yes", 'type' => "radio",
        'options' => array('yes' => __('Open', SAKURA_DOMAIN), 'no' => __('Close', SAKURA_DOMAIN),)
    );

    $options[] = array(
        'name' => __('Home Article Style', SAKURA_DOMAIN), 'id' => 'post_list_style', 'std' => "imageflow",
        'type' => "radio", 'options' => array(
            'standard' => __('Standard', SAKURA_DOMAIN), 'imageflow' => __('Graphic', SAKURA_DOMAIN),
        )
    );

    $options[] = array(
        'name' => __('Home Article Feature Images (Only Valid for Standard Mode)', SAKURA_DOMAIN), 'id' => 'list_type',
        'std'  => "round", 'type' => "radio", 'options' => array(
            'round' => __('Round', SAKURA_DOMAIN), 'square' => __('Square', SAKURA_DOMAIN),
        )
    );

    $options[] = array(
        'name' => __('Home Article Feature Images Alignment (Only for Graphic Mode, Default Left and Right Alternate)', SAKURA_DOMAIN),
        'id'   => 'feature_align', 'std' => "alternate", 'type' => "radio", 'options' => array(
            'left'      => __('Left', SAKURA_DOMAIN), 'right' => __('Right', SAKURA_DOMAIN),
            'alternate' => __('Alternate', SAKURA_DOMAIN),
        )
    );

    $options[] = array(
        'name'    => __('Paging Mode', SAKURA_DOMAIN), 'id' => 'pagenav_style', 'std' => "ajax", 'type' => "radio",
        'options' => array(
            'ajax' => __('Ajax load', SAKURA_DOMAIN), 'np' => __('Previous and next page', SAKURA_DOMAIN),
        )
    );
    ...
    $options[] = array(
        ...
        'id'   => 'auto_load_post', 'std' => '233', 'type' => 'select', 'options' => array(
            '0'   => __('0', SAKURA_DOMAIN), '1' => __('1', SAKURA_DOMAIN), '2' => __('2', SAKURA_DOMAIN),
            '3'   => __('3', SAKURA_DOMAIN), '4' => __('4', SAKURA_DOMAIN), '5' => __('5', SAKURA_DOMAIN),
            '6'   => __('6', SAKURA_DOMAIN), '7' => __('7', SAKURA_DOMAIN), '8' => __('8', SAKURA_DOMAIN),
            '9'   => __('9', SAKURA_DOMAIN), '10' => __('10', SAKURA_DOMAIN),
    ...
    $options[] = array(
        ...
        'desc' => __('Footer description, support for HTML code', SAKURA_DOMAIN), 'id' => 'footer_info',
        'std'  => 'Copyright &copy; by Yesterday17 All Rights Reserved.', 'type' => 'textarea'
    );
    ...
    $options[] = array(
        'name'    => __('Sponsor US', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_sus',
        'std'     => 'tag', 'type' => "images",
    ...
    $options[] = array(
        ...
        'id'   => "release_info", 'std' => "tag", 'type' => "images", 'options' => array(
    ...
    $options[] = array(
        'name'    => __('HomePage-Setting', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_home',
        'std'     => 'tag', 'type' => "images",
        'options' => array('tag' => 'https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/setting/homepage.png',),
    );

    $options[] = array(
        'name'    => __('First Screen', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_homefs',
        'std'     => 'tag', 'type' => "images",
        'options' => array('tag' => 'https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/setting/tips/homepage-firstscreen.png',),
    );

    $options[] = array(
        'name' => __('Main Switch', SAKURA_DOMAIN), 'desc' => __('Default on, check off', SAKURA_DOMAIN),
        'id'   => 'main-switch', 'std' => '0', 'type' => 'checkbox'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'infor-bar', 'std' => '0', 'type' => 'checkbox'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'social-card', 'std' => '0', 'type' => 'checkbox'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'background-rgs', 'std' => '1', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Information Bar Style', SAKURA_DOMAIN), 'id' => 'infor-bar-style', 'std' => "v1",
        'type' => "radio", 'options' => array(
    ...
    $options[] = array(
        ...
        'desc' => __('Fill in the number, the recommended value is 10 to 20', SAKURA_DOMAIN), 'id' => 'info-radius',
        'std'  => '15', 'class' => 'mini', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Social Card Fillet', SAKURA_DOMAIN),
        'desc' => __('Fill in the number, the recommended value is 10 to 20', SAKURA_DOMAIN), 'id' => 'img-radius',
        'std'  => '15', 'class' => 'mini', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Information Bar Avatar Fillet', SAKURA_DOMAIN),
        'desc' => __('Fill in the number, the recommended value is 90 to 110', SAKURA_DOMAIN), 'id' => 'head-radius',
        'std'  => '100', 'class' => 'mini', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Cover Random Graphs Option', SAKURA_DOMAIN),
        'desc' => __('Select how to call the cover random image', SAKURA_DOMAIN), 'id' => 'cover_cdn_options',
        'std'  => "type_3", 'type' => "select", 'options' => array(
    ...
    $options[] = array(
        ...
        'desc' => __('It is off by default and enabled by check', SAKURA_DOMAIN), 'id' => 'cover_beta', 'std' => '0',
        'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Webp Optimization / External API PC Random Graphs Url', SAKURA_DOMAIN),
        'desc' => sprintf(__('Fill in the manifest path for random picture display, please refer to <a href = "https: //github.com/mashirozx/Sakura/wiki/options">Wiki </a>. If you select webp images above, click <a href = "%s">here</a> to update manifest', SAKURA_DOMAIN), rest_url('sakura/v1/database/update')),
        'id'   => 'cover_cdn', 'std' => 'https://api.btstu.cn/sjbz/api.php?lx=dongman&format=images', 'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'cover_cdn_mobile', 'std' => 'https://api.uomg.com/api/rand.img2?sort=二次元&format=images',
        'type' => 'text'
    );

    $options[] = array(
        'name' => __('Full-Screen Display', SAKURA_DOMAIN), 'desc' => __('Default on, check off', SAKURA_DOMAIN),
        'id'   => 'focus_height', 'std' => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Cover Video', SAKURA_DOMAIN), 'desc' => __('Check on', SAKURA_DOMAIN), 'id' => 'focus_amv',
        'std'  => '0', 'type' => 'checkbox'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'focus_mvlive', 'std' => '0', 'type' => 'checkbox'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'amv_title', 'std' => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Cover Random Graphs Filter', SAKURA_DOMAIN), 'id' => 'focus_img_filter',
        'std'  => "filter-nothing", 'type' => "radio", 'options' => array(
            'filter-nothing' => __('Nothing', SAKURA_DOMAIN), 'filter-undertint' => __('Undertint', SAKURA_DOMAIN),
            'filter-dim'     => __('Dim', SAKURA_DOMAIN), 'filter-grid' => __('Grid', SAKURA_DOMAIN),
            'filter-dot'     => __('Dot', SAKURA_DOMAIN),
        )
    );

    $options[] = array(
        'name'    => __('Second Screen', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_homess',
        'std'     => 'tag', 'type' => "images",
    ...
    $options[] = array(
        'name' => __('Announcement', SAKURA_DOMAIN), 'desc' => __('Default off, check on', SAKURA_DOMAIN),
        'id'   => 'head_notice', 'std' => '0', 'type' => 'checkbox'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'post_cover_options', 'std' => "type_1", 'type' => "select", 'options' => array(
    ...
    $options[] = array(
        ...
        'desc' => __('Fill in the custom image api url.', SAKURA_DOMAIN), 'id' => 'post_cover', 'std' => '',
        'type' => 'text'
    );

    $options[] = array(
        'name' => __('Home Page Article Details Icon Switch', SAKURA_DOMAIN),
        'desc' => __('Default on, check off', SAKURA_DOMAIN), 'id' => 'hpage-art-dis', 'std' => '0',
        'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Focus Area', SAKURA_DOMAIN), 'desc' => __('Default on', SAKURA_DOMAIN), 'id' => 'focus-area',
        'std'  => '1', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Focus Area Style', SAKURA_DOMAIN), 'id' => 'focus-area-style', 'std' => "left_and_right",
        'type' => "radio", 'options' => array(
    ...
    $options[] = array(
        ...
        'id'   => 'focus-area-title', 'std' => '聚焦', 'class' => 'mini', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Focus Area First Image', SAKURA_DOMAIN), 'desc' => __('size 257px*160px', SAKURA_DOMAIN),
        'id'   => 'feature1_img',
    ...
    $options[] = array(
        'name' => __('Focus Area First Title', SAKURA_DOMAIN), 'desc' => __('Focus Area First Title', SAKURA_DOMAIN),
        'id'   => 'feature1_title', 'std' => 'First Focus', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Focus Area First Description', SAKURA_DOMAIN),
        'desc' => __('Focus Area First Description', SAKURA_DOMAIN), 'id' => 'feature1_description',
        'std'  => 'This is a brief introduction of the focus area', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Focus Area First Link', SAKURA_DOMAIN), 'desc' => __('Focus Area First Link', SAKURA_DOMAIN),
        'id'   => 'feature1_link', 'std' => '#', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Focus Area Second Image', SAKURA_DOMAIN), 'desc' => __('size 257px*160px', SAKURA_DOMAIN),
        'id'   => 'feature2_img',
        'std'  => "https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/background/foreground/focus.png",
        'type' => 'upload'
    );
    ...
    $options[] = array(
        'name' => __('Focus Area Second Title', SAKURA_DOMAIN), 'desc' => __('Focus Area Second Title', SAKURA_DOMAIN),
        'id'   => 'feature2_title', 'std' => 'Second Focus', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Focus Area Second Description', SAKURA_DOMAIN),
        'desc' => __('Focus Area Second Description', SAKURA_DOMAIN), 'id' => 'feature2_description',
        'std'  => 'This is a brief introduction of the focus area', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Focus Area Second Link', SAKURA_DOMAIN), 'desc' => __('Focus Area Second Link', SAKURA_DOMAIN),
        'id'   => 'feature2_link', 'std' => '#', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Focus Area Third Image', SAKURA_DOMAIN), 'desc' => __('size 257px*160px', SAKURA_DOMAIN),
        'id'   => 'feature3_img',
        'std'  => "https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/background/foreground/focus.png",
        'type' => 'upload'
    );
    ...
    $options[] = array(
        'name' => __('Focus Area Third Title', SAKURA_DOMAIN), 'desc' => __('Focus Area Third Title', SAKURA_DOMAIN),
        'id'   => 'feature3_title', 'std' => 'Third Focus', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Focus Area Third Description', SAKURA_DOMAIN),
        'desc' => __('Focus Area Third Description', SAKURA_DOMAIN), 'id' => 'feature3_description',
        'std'  => 'This is a brief introduction of the focus area', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Focus Area Third Link', SAKURA_DOMAIN), 'desc' => __('Focus Area Third Link', SAKURA_DOMAIN),
        'id'   => 'feature3_link', 'std' => '#', 'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'homepage_title', 'std' => '記事', 'class' => 'mini', 'type' => 'text'
    );
    ...
    $options[] = array(
        'name'    => __('Post-Setting', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_post',
        'std'     => 'tag', 'type' => "images",
        'options' => array('tag' => 'https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/setting/post.png',),
    );

    $options[] = array(
        'name' => __('Post Style', SAKURA_DOMAIN), 'id' => 'entry_content_theme', 'std' => SAKURA_DOMAIN,
        'type' => "radio", 'options' => array(
            SAKURA_DOMAIN => __('Default Style', SAKURA_DOMAIN), 'github' => __('GitHub Style', SAKURA_DOMAIN),
        )
    );

    $options[] = array(
        'name'    => __('Post Like', SAKURA_DOMAIN), 'id' => 'post_like', 'std' => "yes", 'type' => "radio",
        'options' => array('yes' => __('Open', SAKURA_DOMAIN), 'no' => __('Close', SAKURA_DOMAIN),)
    );

    $options[] = array(
        'name'    => __('Post Share', SAKURA_DOMAIN), 'id' => 'post_share', 'std' => "yes", 'type' => "radio",
        'options' => array('yes' => __('Open', SAKURA_DOMAIN), 'no' => __('Close', SAKURA_DOMAIN),)
    );

    $options[] = array(
        'name'    => __('Previous and Next', SAKURA_DOMAIN), 'id' => 'post_nepre', 'std' => "yes", 'type' => "radio",
        'options' => array('yes' => __('Open', SAKURA_DOMAIN), 'no' => __('Close', SAKURA_DOMAIN),)
    );

    $options[] = array(
        'name'    => __('Author Profile', SAKURA_DOMAIN), 'id' => 'author_profile', 'std' => "yes", 'type' => "radio",
        'options' => array('yes' => __('Open', SAKURA_DOMAIN), 'no' => __('Close', SAKURA_DOMAIN),)
    );

    $options[] = array(
        'name'    => __('Comment Shrink', SAKURA_DOMAIN), 'id' => 'toggle-menu', 'std' => "yes", 'type' => "radio",
        'options' => array('yes' => __('Open', SAKURA_DOMAIN), 'no' => __('Close', SAKURA_DOMAIN),)
    );

    $options[] = array(
        'name' => __('Comment Textarea Image', SAKURA_DOMAIN),
        'desc' => __('NO image if left this blank', SAKURA_DOMAIN), 'id' => 'comment-image', 'type' => 'upload'
    );

    $options[] = array(
        'name' => __('Author information at The End of The Paper', SAKURA_DOMAIN),
        'desc' => __('Check to enable', SAKURA_DOMAIN), 'id' => 'show_authorprofile', 'std' => '1', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Post Lincenses', SAKURA_DOMAIN), 'desc' => __('Check close', SAKURA_DOMAIN),
        'id'   => 'post-lincenses', 'std' => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Alipay Reward', SAKURA_DOMAIN), 'desc' => __('Alipay qrcode', SAKURA_DOMAIN),
        'id'   => 'alipay_code', 'type' => 'upload'
    );

    $options[] = array(
        'name' => __('Wechat Reward', SAKURA_DOMAIN), 'desc' => __('Wechat qrcode ', SAKURA_DOMAIN),
        'id'   => 'wechat_code', 'type' => 'upload'
    );
    ...
    $options[] = array(
        'name'    => __('Social-Setting', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_social',
        'std'     => 'tag', 'type' => "images",
        'options' => array('tag' => 'https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/setting/social.png',),
    );

    $options[] = array(
        'name' => __('Wechat', SAKURA_DOMAIN), 'desc' => __('Wechat qrcode', SAKURA_DOMAIN), 'id' => 'wechat',
        'type' => 'upload'
    );

    $options[] = array(
        'name' => __('Sina Weibo', SAKURA_DOMAIN), 'desc' => __('Sina Weibo address', SAKURA_DOMAIN), 'id' => 'sina',
        'std'  => '', 'type' => 'text'
    );
    ...
    $options[] = array(
        'name' => __('Telegram', SAKURA_DOMAIN), 'desc' => __('Telegram link', SAKURA_DOMAIN), 'id' => 'telegram',
        'std'  => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Qzone', SAKURA_DOMAIN), 'desc' => __('Qzone address', SAKURA_DOMAIN), 'id' => 'qzone',
        'std'  => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('GitHub', SAKURA_DOMAIN), 'desc' => __('GitHub address', SAKURA_DOMAIN), 'id' => 'github',
        'std'  => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Lofter', SAKURA_DOMAIN), 'desc' => __('Lofter address', SAKURA_DOMAIN), 'id' => 'lofter',
        'std'  => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('BiliBili', SAKURA_DOMAIN), 'desc' => __('BiliBili address', SAKURA_DOMAIN), 'id' => 'bili',
        'std'  => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Youku video', SAKURA_DOMAIN), 'desc' => __('Youku video address', SAKURA_DOMAIN), 'id' => 'youku',
        'std'  => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Netease Cloud Music', SAKURA_DOMAIN), 'desc' => __('Netease Cloud Music address', SAKURA_DOMAIN),
        'id'   => 'wangyiyun', 'std' => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Twitter', SAKURA_DOMAIN), 'desc' => __('Twitter address', SAKURA_DOMAIN), 'id' => 'twitter',
        'std'  => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Facebook', SAKURA_DOMAIN), 'desc' => __('Facebook address', SAKURA_DOMAIN), 'id' => 'facebook',
        'std'  => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Jianshu', SAKURA_DOMAIN), 'desc' => __('Jianshu address', SAKURA_DOMAIN), 'id' => 'jianshu',
        'std'  => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('CSDN', SAKURA_DOMAIN), 'desc' => __('CSND community address', SAKURA_DOMAIN), 'id' => 'csdn',
        'std'  => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Zhihu', SAKURA_DOMAIN), 'desc' => __('Zhihu address', SAKURA_DOMAIN), 'id' => 'zhihu',
        'std'  => '', 'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'email_name', 'std' => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Email-Domain', SAKURA_DOMAIN),
        'desc' => __('The domain.com part of name@domain.com', SAKURA_DOMAIN), 'id' => 'email_domain', 'std' => '',
        'type' => 'text'
    );
    ...
    $options[] = array(
        'name'    => __('Foreground-Setting', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_fore',
        'std'     => 'tag', 'type' => "images",
        'options' => array('tag' => 'https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/setting/foreground.png',),
    );

    $options[] = array(
        'name'    => __('Settings Menu', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_foresm',
        'std'     => 'tag', 'type' => "images",
    ...
    $options[] = array(
        ...
        'desc' => __('Check on by default, uncheck to switch to simple mode', SAKURA_DOMAIN), 'id' => 'full-mode',
        'std'  => '1', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Extra Background Switching(Heart-shaped icon)', SAKURA_DOMAIN),
        'desc' => __('Check on by default', SAKURA_DOMAIN), 'id' => 'extra-bg', 'std' => '1', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Extra Background Switching(Star-shaped icon)', SAKURA_DOMAIN),
        'desc' => __('Check on by default', SAKURA_DOMAIN), 'id' => 'extra-bg2', 'std' => '1', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Extra Background Switching(Square-shaped icon)', SAKURA_DOMAIN),
        'desc' => __('Check on by default', SAKURA_DOMAIN), 'id' => 'extra-bg3', 'std' => '1', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Extra Background Switching(Lemon-shaped icon)', SAKURA_DOMAIN),
        'desc' => __('Check on by default', SAKURA_DOMAIN), 'id' => 'extra-bg4', 'std' => '1', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Default Foreground Background', SAKURA_DOMAIN),
        'desc' => __('Default Foreground Background, Fill in URL', SAKURA_DOMAIN), 'id' => 'sakura_skin_bg1',
        'std'  => 'none', 'type' => 'text'
    );
    ...
    $options[] = array(
        'name'    => __('Animation', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_foreani',
        'std'     => 'tag', 'type' => "images",
        'options' => array('tag' => 'https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/setting/tips/foreground-animation.png',),
    );

    $options[] = array(
        'name' => __('Homepage Animation', SAKURA_DOMAIN), 'desc' => __('Check open', SAKURA_DOMAIN),
        'id'   => 'homepage-ani', 'std' => '1', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Article Title Line Animation', SAKURA_DOMAIN), 'desc' => __('Check open', SAKURA_DOMAIN),
        'id'   => 'title-line', 'std' => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Article Title Animation', SAKURA_DOMAIN), 'desc' => __('Check open', SAKURA_DOMAIN),
        'id'   => 'title-ani', 'std' => '1', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Homepage Animation Time', SAKURA_DOMAIN), 'desc' => __('Fill in Number', SAKURA_DOMAIN),
        'id'   => 'hp-ani-t', 'std' => '2', 'class' => 'mini', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Article Title Animation Time', SAKURA_DOMAIN), 'desc' => __('Fill in Number', SAKURA_DOMAIN),
        'id'   => 'title-ani-t', 'std' => '2', 'class' => 'mini', 'type' => 'text'
    );

    $options[] = array(
        'name'    => __('Others', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_foreot',
        'std'     => 'tag', 'type' => "images",
    ...
    $options[] = array(
        ...
        'desc'  => __('Fill in numbers between 0.1 and 1', SAKURA_DOMAIN), 'id' => 'homepagebgtmd', 'std' => '0.8',
        'class' => 'mini', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Close Foreground Login Entry', SAKURA_DOMAIN),
        'desc' => __('Check off by default', SAKURA_DOMAIN), 'id' => 'user-avatar', 'std' => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Search Icon Normal Size', SAKURA_DOMAIN), 'desc' => __('Check off by default', SAKURA_DOMAIN),
        'id'   => 'search-ico', 'std' => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Footer Float Music Player', SAKURA_DOMAIN),
        'desc' => __('Choose which platform you\'ll use.', SAKURA_DOMAIN), 'id' => 'aplayer_server', 'std' => "netease",
        'type' => "select", 'options' => array(
            'netease' => __('Netease Cloud Music (default)', SAKURA_DOMAIN),
            'xiami'   => __('Xiami Music', SAKURA_DOMAIN), 'kugou' => __('KuGou Music (may fail)', SAKURA_DOMAIN),
            'baidu'   => __('Baidu Music（Overseas server does not support）', SAKURA_DOMAIN),
            'tencent' => __('QQ Music (may fail) ', SAKURA_DOMAIN), 'off' => __('Off', SAKURA_DOMAIN),
        )
    );
    ...
    $options[] = array(
        ...
        'id'   => 'aplayer_playlistid', 'std' => '3124382377', 'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'aplayer_cookie', 'std' => '', 'type' => 'textarea'
    );

    $options[] = array(
        'name' => __('Pjax Refresh', SAKURA_DOMAIN),
        'desc' => __('Check on, and the principle is the same as Ajax.', SAKURA_DOMAIN), 'id' => 'poi_pjax',
        'std'  => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('NProgress Progress Bar', SAKURA_DOMAIN), 'desc' => __('Check on by default', SAKURA_DOMAIN),
        'id'   => 'nprogress_on', 'std' => '1', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Sidebar Widget', SAKURA_DOMAIN), 'desc' => __('Default off, check on', SAKURA_DOMAIN),
        'id'   => 'sakura_widget', 'std' => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Sidebar Widget Background Image', SAKURA_DOMAIN), 'desc' => __('Fill in the URL', SAKURA_DOMAIN),
        'id'   => 'sakura_widget_bg', 'std' => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('More JavaScript', SAKURA_DOMAIN), 'desc' => __('check on', SAKURA_DOMAIN), 'id' => 'addmorejs',
        'std'  => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('More JavaScript Url', SAKURA_DOMAIN),
        'desc' => __('Add More JavaScript Url, Fill in the URL', SAKURA_DOMAIN), 'id' => 'addmorejsurl', 'std' => '',
        'type' => 'text'
    );
    ...
    $options[] = array(
        'name'    => __('Backstage-Setting', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_back',
        'std'     => 'tag', 'type' => "images",
    ...
    $options[] = array(
        ...
        'desc' => __('Backstage Background Image', SAKURA_DOMAIN), 'id' => 'admin_menu_bg',
    ...
    $options[] = array(
        ...
        'desc' => __('Use the default image if left this blank', SAKURA_DOMAIN), 'id' => 'login_bg', 'type' => 'upload'
    );

    $options[] = array(
        'name' => __('Background Virtualization of Login Interface', SAKURA_DOMAIN),
        'desc' => __('It is off by default and enabled by check', SAKURA_DOMAIN), 'id' => 'login_blur', 'std' => '0',
        'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Login Interface Logo', SAKURA_DOMAIN),
        'desc' => __('Used for login interface display', SAKURA_DOMAIN), 'id' => 'logo_img',
        'std'  => "https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/basic/logo-login.png",
        'type' => 'upload'
    );

    $options[] = array(
        'name' => __('Login/Registration Related Settings', SAKURA_DOMAIN), 'desc' => __(' ', 'space', SAKURA_DOMAIN),
        'id'   => 'login_tip', 'std' => '', 'type' => 'typography '
    );
    ...
    $options[] = array(
        ...
        'id'   => 'exregister_url', 'std' => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Allow Users to Register', SAKURA_DOMAIN),
        'desc' => __('Check to allow users to register at the frontend', SAKURA_DOMAIN), 'id' => 'ex_register_open',
        'std'  => '0', 'type' => 'checkbox'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'login_urlskip', 'std' => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Login Validation', SAKURA_DOMAIN),
        'desc' => __('Check to enable slide verification', SAKURA_DOMAIN), 'id' => 'login_pf', 'std' => '1',
        'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Registration Verification (Frontend Only, Backend Forced Open)', SAKURA_DOMAIN),
        'desc' => __('Check to enable slide verification', SAKURA_DOMAIN), 'id' => 'login_validate', 'std' => '0',
        'type' => 'checkbox'
    );
    ...
    $options[] = array(
        'name'    => __('Advanced-Setting', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_adv',
        'std'     => 'tag', 'type' => "images",
        'options' => array('tag' => 'https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/setting/advanced.png',),
    );

    $options[] = array(
        'name'    => __('Localize', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_advlo',
        'std'     => 'tag', 'type' => "images",
    ...
    $options[] = array(
        ...
        'id'   => 'jsdelivr_cdn_test', 'std' => '0', 'type' => 'checkbox'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'app_no_jsdelivr_cdn', 'std' => '1', 'type' => 'checkbox'
    );

    $options[] = array(
        'name'    => __('Others', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_advot',
        'std'     => 'tag', 'type' => "images",
    ...
    $options[] = array(
        ...
        'id'   => 'gravatar_proxy', 'std' => "sdn.geekzu.org/avatar", 'type' => "text"
    );
    ...
    $options[] = array(
        ...
        'id'   => 'qiniu_cdn', 'std' => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Google Analytics', SAKURA_DOMAIN), 'desc' => __('UA-xxxxx-x', SAKURA_DOMAIN),
        'id'   => 'google_analytics_id', 'std' => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('CNZZ Statistics (Not Recommand)', SAKURA_DOMAIN),
        'desc' => __('Statistics code, which will be invisible in web page.', SAKURA_DOMAIN), 'id' => 'site_statistics',
        'std'  => '', 'type' => 'textarea'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'site_custom_style', 'std' => '', 'type' => 'textarea'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'classify_display', 'std' => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Images Category', SAKURA_DOMAIN),
        'desc' => __('Fill in category ID, multiple IDs are divided by a comma ","', SAKURA_DOMAIN),
        'id'   => 'image_category', 'std' => '', 'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'cookie_version', 'std' => '', 'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'time_zone_fix', 'std' => '0', 'class' => 'mini', 'type' => 'text'
    );
    ...
    */
    ...
    $options[] = array(
        'name'    => __('Function-Setting', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_func',
        'std'     => 'tag', 'type' => "images",
    ...
    $options[] = array(
        ...
        'id'   => 'bilibili_id', 'std' => '13972644', 'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'bilibili_cookie', 'std' => 'LIVE_BUVID=', 'type' => 'textarea'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'open_useragent', 'std' => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Comment Location Infomation', SAKURA_DOMAIN),
        'desc' => __('Check to enable, display the user\'s location info', SAKURA_DOMAIN), 'id' => 'open_location',
        'std'  => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Comment Image Upload API', SAKURA_DOMAIN), 'id' => 'img_upload_api', 'std' => "imgur",
        'type' => "radio", 'options' => array(
    ...
    $options[] = array(
        ...
        'id'   => 'imgur_client_id', 'std' => '', 'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'smms_client_id', 'std' => '', 'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'chevereto_api_key', 'std' => '', 'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'cheverto_url', 'std' => 'https://your.cherverto.com', 'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'cmt_image_proxy', 'std' => 'https://images.weserv.nl/?url=', 'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'imgur_upload_image_proxy', 'std' => 'https://api.imgur.com/3/image/', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Statistics Interface', SAKURA_DOMAIN), 'id' => 'statistics_api', 'std' => "theme_build_in",
        'type' => "radio", 'options' => array(
    ...
    $options[] = array(
        'name' => __('Statistical Data Display Format', SAKURA_DOMAIN), 'id' => 'statistics_format', 'std' => "type_1",
        'type' => "radio", 'options' => array(
    ...
    $options[] = array(
        ...
        'id'   => 'open_private_message', 'std' => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('QQ Avatar Link Encryption', SAKURA_DOMAIN),
        'desc' => __('Do not display the user\'s qq avatar links directly.', SAKURA_DOMAIN), 'id' => 'qq_avatar_link',
        'std'  => "off", 'type' => "select", 'options' => array(
    ...
    $options[] = array(
        ...
        'desc' => __('It is the cute one that opens the search interface', SAKURA_DOMAIN), 'id' => 'search-image',
    ...
    $options[] = array(
        ...
        'id'   => 'live_search_comment', 'std' => '0', 'type' => 'checkbox'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'friend_center', 'std' => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Article Page Lazyload Function', SAKURA_DOMAIN), 'desc' => __('Default on', SAKURA_DOMAIN),
        'id'   => 'lazyload', 'std' => '1', 'type' => 'checkbox'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'clipboard_copyright', 'std' => '1', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Mail Template Header', SAKURA_DOMAIN),
        'desc' => __('Set the background picture above your message', SAKURA_DOMAIN), 'id' => 'mail_img',
    ...
    $options[] = array(
        ...
        'id'   => 'mail_user_name', 'std' => 'bibi', 'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'mail_notify', 'std' => '0', 'type' => 'checkbox'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'admin_notify', 'std' => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Human Verification', SAKURA_DOMAIN), 'desc' => __('Enable human verification', SAKURA_DOMAIN),
        'id'   => 'norobot', 'std' => '0', 'type' => 'checkbox'
    );
    ...
    $options[] = array(
        'name'    => __('Enhanced-Setting', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_enhan',
        'std'     => 'tag', 'type' => "images",
        'options' => array('tag' => 'https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/setting/enhanced.png',),
    );

    $options[] = array(
        'name'    => __('Effect', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_enhanef',
        'std'     => 'tag', 'type' => "images",
        'options' => array('tag' => 'https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/setting/tips/enhanced-effect.png',),
    );

    $options[] = array(
        'name' => __('Open SmoothScroll', SAKURA_DOMAIN), 'desc' => __('Check open。', SAKURA_DOMAIN),
        'id'   => 'SmoothScroll', 'std' => '1', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Preload Animation', SAKURA_DOMAIN), 'desc' => __('Check open', SAKURA_DOMAIN), 'id' => 'yjzdh',
        'std'  => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Cherry Blossom Falling Effect', SAKURA_DOMAIN), 'desc' => __('Check open', SAKURA_DOMAIN),
        'id'   => 'sakurajs', 'std' => '0', 'type' => 'checkbox'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'sakura-falling-quantity', 'std' => 'native', 'type' => 'select', 'options' => array(
            'native' => __('native', SAKURA_DOMAIN), 'quarter' => __('quarter', SAKURA_DOMAIN),
            'half'   => __('half', SAKURA_DOMAIN), 'less' => __('less', SAKURA_DOMAIN),
        )
    );

    $options[] = array(
        'name' => __('Wave Effects', SAKURA_DOMAIN), 'desc' => __('Check open', SAKURA_DOMAIN), 'id' => 'bolangcss',
        'std'  => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Footer Suspension Player Default Volume', SAKURA_DOMAIN),
        'desc' => __('Maximum 1 minimum 0', SAKURA_DOMAIN), 'id' => 'playlist_mryl', 'std' => '0.5', 'class' => 'mini',
        'type' => 'text'
    );

    $options[] = array(
        'name' => __('live2D', SAKURA_DOMAIN), 'desc' => __('Check open', SAKURA_DOMAIN), 'id' => 'live2djs',
        'std'  => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Live2D Custom Resource Address', SAKURA_DOMAIN),
        'desc' => __('Fill in Live2D Custom Resource Address', SAKURA_DOMAIN), 'id' => 'live2d-custom',
        'std'  => 'mirai-mamori', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Live2D Custom Resource Version', SAKURA_DOMAIN),
        'desc' => __('Fill in Live2D Custom Resource Version', SAKURA_DOMAIN), 'id' => 'live2d-custom-ver',
        'std'  => 'latest', 'class' => 'mini', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Drop-down Arrow', SAKURA_DOMAIN), 'desc' => __('Check open', SAKURA_DOMAIN), 'id' => 'godown',
        'std'  => '1', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Turn off Drop-down Arrow Mobile Display', SAKURA_DOMAIN),
        'desc' => __('Check by default, cancel opening', SAKURA_DOMAIN), 'id' => 'godown-mb', 'std' => '1',
        'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('A Brief Remark', SAKURA_DOMAIN), 'desc' => __('Check open', SAKURA_DOMAIN), 'id' => 'oneword',
        'std'  => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Load Occupancy Query', SAKURA_DOMAIN), 'desc' => __('Check open', SAKURA_DOMAIN),
        'id'   => 'loadoq', 'std' => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('One Word Typing Effect of Home Page', SAKURA_DOMAIN), 'desc' => __('Check open', SAKURA_DOMAIN),
        'id'   => 'dazi', 'std' => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Double Quotation Marks for Typing Effect', SAKURA_DOMAIN),
        'desc' => __('Check open', SAKURA_DOMAIN), 'id' => 'dazi_yh', 'std' => '0', 'type' => 'checkbox'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'dazi_a', 'std' => '"寒蝉黎明之时,便是重生之日。"', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Homepage One Word Blogger Description', SAKURA_DOMAIN),
        'desc' => __('A self description', SAKURA_DOMAIN), 'id' => 'admin_des', 'std' => '粉色的花瓣，美丽地缠绕在身上。依在风里。',
        'type' => 'textarea'
    );

    $options[] = array(
        'name' => __('Blog Description at the end of The Article', SAKURA_DOMAIN),
        'desc' => __('A self description', SAKURA_DOMAIN), 'id' => 'admin_destwo', 'std' => '粉色的花瓣，美丽地缠绕在身上。依在风里。',
        'type' => 'textarea'
    );

    $options[] = array(
        'name' => __('Note Effects', SAKURA_DOMAIN), 'desc' => __('Check open', SAKURA_DOMAIN), 'id' => 'audio',
        'std'  => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Logo Special Effects', SAKURA_DOMAIN), 'desc' => __('Check open', SAKURA_DOMAIN),
        'id'   => 'logocss', 'std' => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Logo Text A', SAKURA_DOMAIN),
        'desc' => __('Fill in the front part of your logo text', SAKURA_DOMAIN), 'id' => 'logo_a', 'std' => ' ',
        'type' => 'text'
    );

    $options[] = array(
        'name' => __('Logo Text B', SAKURA_DOMAIN),
        'desc' => __('Fill in the middle part of your logo text', SAKURA_DOMAIN), 'id' => 'logo_b', 'std' => ' ',
        'type' => 'text'
    );

    $options[] = array(
        'name' => __('Logo Text C', SAKURA_DOMAIN), 'desc' => __('Fill in the back of your logo', SAKURA_DOMAIN),
        'id'   => 'logo_c', 'std' => ' ', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Logo Secondary Text', SAKURA_DOMAIN),
        'desc' => __('Fill in the secondary text of your logo.', SAKURA_DOMAIN), 'id' => 'logo_two', 'std' => '',
        'type' => 'text'
    );

    $options[] = array(
        'name'    => __('Morse', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_enhanmo',
        'std'     => 'tag', 'type' => "images",
    ...
    $options[] = array(
        ...
        'desc' => __('Apply to global, fill in link.', SAKURA_DOMAIN), 'id' => 'cursor-nor',
    ...
    $options[] = array(
        ...
        'desc' => __('Return to the above for PC', SAKURA_DOMAIN), 'id' => 'cursor-no',
    ...
    $options[] = array(
        ...
        'desc' => __('Used to select a place', SAKURA_DOMAIN), 'id' => 'cursor-ayu',
    ...
    $options[] = array(
        ...
        'desc' => __('Used to select a Text', SAKURA_DOMAIN), 'id' => 'cursor-text',
    ...
    $options[] = array(
        ...
        'desc' => __('Used to working condition', SAKURA_DOMAIN), 'id' => 'cursor-work',
        'std'  => 'https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/cursor/work.cur', 'type' => 'text'
    );
    ...
    $options[] = array(
        'name'    => __('Fonts-Setting', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_fonts',
        'std'     => 'tag', 'type' => "images",
        'options' => array('tag' => 'https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/setting/fonts.png',),
    );

    $options[] = array(
        'name'    => __('Custom', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_fontscu',
        'std'     => 'tag', 'type' => "images",
    ...
    $options[] = array(
        ...
        'id'   => 'fontweight', 'std' => '', 'class' => 'mini', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Reference External Font', SAKURA_DOMAIN), 'desc' => __('Check open', SAKURA_DOMAIN),
        'id'   => 'refer-ext-font', 'std' => '0', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('External Font Address', SAKURA_DOMAIN), 'desc' => __('Fill in font address.', SAKURA_DOMAIN),
        'id'   => 'ext-font-address', 'std' => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('External Font Name', SAKURA_DOMAIN), 'desc' => __('Fill in the font name.', SAKURA_DOMAIN),
        'id'   => 'ext-font-name', 'std' => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Google Fonts Api Address', SAKURA_DOMAIN),
        'desc' => __('Fill in Google Fonts API Address', SAKURA_DOMAIN), 'id' => 'gfontsapi',
        'std'  => 'fonts.googleapis.com', 'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'addfonts', 'std' => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Global Default Font', SAKURA_DOMAIN), 'desc' => __('Fill in font name', SAKURA_DOMAIN),
        'id'   => 'global-default-font', 'std' => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Global Font 2', SAKURA_DOMAIN), 'desc' => __('Fill in font name', SAKURA_DOMAIN),
        'id'   => 'global-font2', 'std' => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Front Page Title Font', SAKURA_DOMAIN), 'desc' => __('Fill in font name', SAKURA_DOMAIN),
        'id'   => 'font-title', 'std' => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Front Page One Word Font', SAKURA_DOMAIN), 'desc' => __('Fill in font name', SAKURA_DOMAIN),
        'id'   => 'font-oneword', 'std' => '', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Front Page Key Title Font', SAKURA_DOMAIN), 'desc' => __('Fill in font name', SAKURA_DOMAIN),
        'id'   => 'keytitlefont', 'std' => '', 'type' => 'text'
    );

    $options[] = array(
        'name'    => __('Size', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_fontssi',
        'std'     => 'tag', 'type' => "images",
    ...
    $options[] = array(
        ...
        'desc' => __('Fill in Number. Between 10 and 20 is recommended', SAKURA_DOMAIN), 'id' => 'global-fontsize',
        'std'  => '', 'class' => 'mini', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Article Title Size', SAKURA_DOMAIN),
        'desc' => __('Fill in Number. Between 15 and 20 is recommended', SAKURA_DOMAIN), 'id' => 'article-title-size',
        'std'  => '', 'class' => 'mini', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Article Tips Size', SAKURA_DOMAIN),
        'desc' => __('Fill in Number. Between 10 and 15 is recommended', SAKURA_DOMAIN), 'id' => 'article-tips-size',
        'std'  => '', 'class' => 'mini', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Front Page One Word FontSize', SAKURA_DOMAIN),
        'desc' => __('Fill in Number. Between 10 and 20 is recommended', SAKURA_DOMAIN), 'id' => 'fontsize-oneword',
        'std'  => '', 'class' => 'mini', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Font Size of The First Key Title', SAKURA_DOMAIN),
        'desc' => __('Fill in Number. Between 70 and 90 is recommended', SAKURA_DOMAIN), 'id' => 'keytitle_size',
        'std'  => '80', 'class' => 'mini', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Article Page Title Size', SAKURA_DOMAIN),
        'desc' => __('Fill in Number. Between 25 and 30 is recommended', SAKURA_DOMAIN), 'id' => 'article-paget',
        'std'  => '', 'class' => 'mini', 'type' => 'text'
    );

    $options[] = array(
        'name'    => __('Others', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_fontsot',
        'std'     => 'tag', 'type' => "images",
    ...
    $options[] = array(
        ...
        'id'   => 'logo_zt', 'std' => 'https://cdn.jsdelivr.net/gh/acai66/mydl/fonts/wenyihei/wenyihei-subfont.css',
        'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'id'   => 'logo_ztmc', 'std' => 'wenyihei-subfont', 'type' => 'text'
    );
    ...
    $options[] = array(
        'name'    => __('Theme-Setting', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_theme',
        'std'     => 'tag', 'type' => "images",
        'options' => array('tag' => 'https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/setting/theme.png',),
    );

    $options[] = array(
        'name'    => __('Display Icon Selection', SAKURA_DOMAIN), 'desc' => __('Choose icon color', SAKURA_DOMAIN),
        'id'      => 'webweb_img',
    ...
    $options[] = array(
        'name' => __('Theme Color', SAKURA_DOMAIN), 'id' => 'theme_skin', 'std' => "#FB98C0",
        'desc' => __('Custom theme color', SAKURA_DOMAIN), 'type' => "color",
    );

    $options[] = array(
        'name' => __('Theme Color Matching Color', SAKURA_DOMAIN), 'id' => 'theme_skinm', 'std' => "#87B6FA",
        'desc' => __('Custom theme color', SAKURA_DOMAIN), 'type' => "color",
    );

    $options[] = array(
        'name' => __('Theme Light Color Management', SAKURA_DOMAIN), 'id' => 'light-cmanage', 'std' => "sep",
        'type' => "radio", 'options' => array(
            'mer' => __('Merge Options', SAKURA_DOMAIN), 'sep' => __('Separation Options', SAKURA_DOMAIN),
        )
    );

    $options[] = array(
        'name' => __('Theme Color (Light)', SAKURA_DOMAIN), 'id' => 'light-color', 'std' => "#FFE1ED",
        'desc' => __('Custom theme color', SAKURA_DOMAIN), 'type' => "color",
    );

    $options[] = array(
        'name'    => __('Darkmode', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_themedm',
        'std'     => 'tag', 'type' => "images",
        'options' => array('tag' => 'https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/setting/tips/theme-darkmode.png',),
    );

    $options[] = array(
        'name' => __('Theme Color (Dark mode)', SAKURA_DOMAIN), 'id' => 'theme_dark', 'std' => "#BD144A",
        'desc' => __('Custom theme color', SAKURA_DOMAIN), 'type' => "color",
    );

    $options[] = array(
        'name' => __('Automatic Switching Dark Mode (22:00-7:00)', SAKURA_DOMAIN),
        'desc' => __('Check open', SAKURA_DOMAIN), 'id' => 'darkmode', 'std' => '1', 'type' => 'checkbox'
    );

    $options[] = array(
        'name' => __('Image Brightness in Dark Mode', SAKURA_DOMAIN), 'desc' => __('Fill in Number', SAKURA_DOMAIN),
        'id'   => 'dark_imgbri', 'std' => '0.8', 'class' => 'mini', 'type' => 'text'
    );

    $options[] = array(
        'name' => __('Dark Mode Widget Transparency', SAKURA_DOMAIN), 'id' => 'dark-widget-tmd', 'std' => "0.7",
        'desc' => __('Fill in the alpha value from 0 to 1 here', SAKURA_DOMAIN), 'type' => "text", 'class' => 'mini',
    );

    $options[] = array(
        'name'    => __('Homepage', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_themehp',
        'std'     => 'tag', 'type' => "images",
        'options' => array('tag' => 'https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/setting/tips/theme-homepage.png',),
    );

    $options[] = array(
        'name'  => __('Information Bar Background Color (RGBA) Red', SAKURA_DOMAIN), 'id' => 'infor-bar-bg-cr',
        'std'   => "255", 'desc' => __('Fill in the red value from 0 to 255 here', SAKURA_DOMAIN), 'type' => "text",
        'class' => 'mini',
    );

    $options[] = array(
        'name'  => __('Information Bar Background Color (RGBA) Green', SAKURA_DOMAIN), 'id' => 'infor-bar-bg-cg',
        'std'   => "255", 'desc' => __('Fill in the green value from 0 to 255 here', SAKURA_DOMAIN), 'type' => "text",
        'class' => 'mini',
    );

    $options[] = array(
        'name'  => __('Information Bar Background Color (RGBA) Blue', SAKURA_DOMAIN), 'id' => 'infor-bar-bg-cb',
        'std'   => "255", 'desc' => __('Fill in the blue value from 0 to 255 here', SAKURA_DOMAIN), 'type' => "text",
        'class' => 'mini',
    );

    $options[] = array(
        'name'  => __('Information Bar Background Color (RGBA) Alpha', SAKURA_DOMAIN), 'id' => 'infor-bar-bg-ca',
        'std'   => "0.8", 'desc' => __('Fill in the alpha value from 0 to 1 here', SAKURA_DOMAIN), 'type' => "text",
        'class' => 'mini',
    );

    $options[] = array(
        'name'  => __('Foreground Menu background Color (RGBA) Red', SAKURA_DOMAIN), 'id' => 'fore-switch-bcr',
        'std'   => "255", 'desc' => __('Fill in the red value from 0 to 255 here', SAKURA_DOMAIN), 'type' => "text",
        'class' => 'mini',
    );

    $options[] = array(
        'name'  => __('Foreground Menu background Color (RGBA) Green', SAKURA_DOMAIN), 'id' => 'fore-switch-bcg',
        'std'   => "255", 'desc' => __('Fill in the green value from 0 to 255 here', SAKURA_DOMAIN), 'type' => "text",
        'class' => 'mini',
    );

    $options[] = array(
        'name'  => __('Foreground Menu background Color (RGBA) Blue', SAKURA_DOMAIN), 'id' => 'fore-switch-bcb',
        'std'   => "255", 'desc' => __('Fill in the blue value from 0 to 255 here', SAKURA_DOMAIN), 'type' => "text",
        'class' => 'mini',
    );

    $options[] = array(
        'name'  => __('Foreground Menu background Color (RGBA) Alpha', SAKURA_DOMAIN), 'id' => 'fore-switch-bca',
        'std'   => "0.8", 'desc' => __('Fill in the alpha value from 0 to 1 here', SAKURA_DOMAIN), 'type' => "text",
        'class' => 'mini',
    );
    ...
    $options[] = array(
        ...
        'id'   => 'fore-switch-sele-bc', 'std' => "#FFE1ED", 'desc' => __('Custom colors', SAKURA_DOMAIN),
        'type' => "color",
    );

    $options[] = array(
        'name' => __('Home Page Article Separator (Light colors are recommended)', SAKURA_DOMAIN),
        'id'   => 'hpage-art-sc', 'std' => "#FFE1ED", 'desc' => __('Custom colors', SAKURA_DOMAIN), 'type' => "color",
    );

    $options[] = array(
        'name' => __('Home Page Article Time Prompt Emphasize Background (Light colors are recommended)', SAKURA_DOMAIN),
        'id'   => 'hpage-art-tpebc', 'std' => "#FFE1ED", 'desc' => __('Custom colors', SAKURA_DOMAIN),
        'type' => "color",
    );

    $options[] = array(
        'name' => __('Home Page Article Border Shadow (Light colors are recommended)', SAKURA_DOMAIN),
        'id'   => 'hpage-art-bsc', 'std' => "#FFE1ED", 'desc' => __('Custom colors', SAKURA_DOMAIN), 'type' => "color",
    );

    $options[] = array(
        'name' => __('Drop Down Arrow Color (Light colors are recommended)', SAKURA_DOMAIN), 'id' => 'godown_skin',
        'std'  => "#FFF", 'desc' => __('Custom colors', SAKURA_DOMAIN), 'type' => "color",
    );

    $options[] = array(
        'name' => __('Home Page Article Time Prompt Accent (Theme colors are recommended)', SAKURA_DOMAIN),
        'id'   => 'hpage-art-tpac', 'std' => "#FB98C0", 'desc' => __('Custom colors', SAKURA_DOMAIN), 'type' => "color",
    );

    $options[] = array(
        'name' => __('Home Page Article Prompt Icon Color (Theme colors are recommended)', SAKURA_DOMAIN),
        'id'   => 'hpage-art-pic', 'std' => "#FB98C0", 'desc' => __('Custom colors', SAKURA_DOMAIN), 'type' => "color",
    );

    $options[] = array(
        'name'  => __('Home Page Focus Background Color (RGBA) Red', SAKURA_DOMAIN), 'id' => 'hpage-focus-bcr',
        'std'   => "255", 'desc' => __('Fill in the red value from 0 to 255 here', SAKURA_DOMAIN), 'type' => "text",
        'class' => 'mini',
    );

    $options[] = array(
        'name'  => __('Home Page Focus Background Color (RGBA) Green', SAKURA_DOMAIN), 'id' => 'hpage-focus-bcg',
        'std'   => "225", 'desc' => __('Fill in the green value from 0 to 255 here', SAKURA_DOMAIN), 'type' => "text",
        'class' => 'mini',
    );

    $options[] = array(
        'name'  => __('Home Page Focus Background Color (RGBA) Blue', SAKURA_DOMAIN), 'id' => 'hpage-focus-bcb',
        'std'   => "237", 'desc' => __('Fill in the blue value from 0 to 255 here', SAKURA_DOMAIN), 'type' => "text",
        'class' => 'mini',
    );

    $options[] = array(
        'name'  => __('Home Page Focus Background Color (RGBA) Alpha', SAKURA_DOMAIN), 'id' => 'hpage-focus-bca',
        'std'   => "0.7", 'desc' => __('Fill in the alpha value from 0 to 1 here', SAKURA_DOMAIN), 'type' => "text",
        'class' => 'mini',
    );

    $options[] = array(
        'name' => __('Home Page Key Title Font Color', SAKURA_DOMAIN), 'id' => 'hpage-ket-tfc', 'std' => "#FFF",
        'desc' => __('Custom theme color', SAKURA_DOMAIN), 'type' => "color",
    );

    $options[] = array(
        'name' => __('Preload Animation Color A', SAKURA_DOMAIN), 'id' => 'preload-ani-c1', 'std' => "#FFE1ED",
        'desc' => __('Custom colors', SAKURA_DOMAIN), 'type' => "color",
    );

    $options[] = array(
        'name' => __('Preload Animation Color B', SAKURA_DOMAIN), 'id' => 'preload-ani-c2', 'std' => "#FB98C0",
        'desc' => __('Custom colors', SAKURA_DOMAIN), 'type' => "color",
    );

    $options[] = array(
        'name'    => __('Backstage Color', SAKURA_DOMAIN), 'desc' => __(' ', SAKURA_DOMAIN), 'id' => 'setting_themebs',
        'std'     => 'tag', 'type' => "images",
        'options' => array('tag' => 'https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@latest/vision/setting/tips/theme-backstage.png',),
    );

    $options[] = array(
        'name' => __('Backstage Main Color (Primary menu)', SAKURA_DOMAIN), 'id' => 'admin_mcp', 'std' => "#99B8FC",
        'desc' => __('Custom color', SAKURA_DOMAIN), 'type' => "color",
    );

    $options[] = array(
        'name' => __('Backstage Main Color (Secondary menu)', SAKURA_DOMAIN), 'id' => 'admin_mcs', 'std' => "#85ABFC",
        'desc' => __('Custom color', SAKURA_DOMAIN), 'type' => "color",
    );

    $options[] = array(
        'name' => __('Backstage Accent Color (For Example, The Prompt Color is Included in This Option)', SAKURA_DOMAIN),
        'id'   => 'admin_acc', 'std' => "#F181A2", 'desc' => __('Custom color', SAKURA_DOMAIN), 'type' => "color",
    );

    $options[] = array(
        'name' => __('Backstage Button Color', SAKURA_DOMAIN), 'id' => 'admin_pb_skin', 'std' => "#85ABFC",
        'desc' => __('Custom color', SAKURA_DOMAIN), 'type' => "color",
    );

    $options[] = array(
        'name' => __('Backstage Font Color', SAKURA_DOMAIN), 'id' => 'admin_font_skin', 'std' => "#FFF",
        'desc' => __('Custom color', SAKURA_DOMAIN), 'type' => "color",
    );
