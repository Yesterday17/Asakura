...
<article class="post post-list" itemscope="" itemtype="http://schema.org/BlogPosting">
    <div class="post-entry">
        <div class="feature">
            ...
            <?php } else { ?>
                <a href="<?php the_permalink(); ?>">
                    ...
                    <img src="<?php bloginfo('template_url'); ?>/inc/content-image/d-<?php echo rand(1, 4) ?>.jpg"/></a>
            <?php } ?>
        </div>
        ...
        <footer class="entry-footer">
            ...
            <div class="info-meta">
                <div class="comnum">
                    <span><i class="iconfont icon-mark"></i><?php comments_popup_link('NOTHING', '1 ' . __("Comment", SAKURA_DOMAIN)/*条评论*/, '% ' . __("Comments", SAKURA_DOMAIN)/*条评论*/); ?></span>
                </div>
                <div class="views">
