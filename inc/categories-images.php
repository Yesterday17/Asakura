...
function z_add_texonomy_field() {
    ...
    echo '<div class="form-field">
		<label for="taxonomy_image">' . __('category/tag image', SAKURA_DOMAIN) /*分类/标签图像*/ . '</label>
...
function z_edit_texonomy_field($taxonomy) {
    ...
    echo '<tr class="form-field">
		<th scope="row" valign="top"><label for="taxonomy_image">' . __('category/tag image', SAKURA_DOMAIN) /*分类/标签图像*/ . '</label></th>
...
function z_taxonomy_image_url($term_id = NULL, $size = 'full', $return_placeholder = FALSE) {
    ...
    if ($return_placeholder)
        return ($taxonomy_image_url != '') ? $taxonomy_image_url : Z_IMAGE_PLACEHOLDER; else
...
function z_change_insert_button_text($safe_text, $text) {
    return str_replace(/** @lang Text */ "Insert into Post", "use this image", $text);
}
