...
function customizer_css() {
    ...
    if (akina_option('shownav')) {
        $result .= '.site-top .lower nav {
            display: block !important;
        }';
    }
    // theme-skin
    if (akina_option('theme_skin')) {
        $result .= '.author-profile i, .post-like a, .post-share .show-share, .sub-text, .we-info a, span.sitename {
        ...
        .download, .link-title {
            border-color: ' . akina_option('theme_skin') . '
        }
        ...
        #aplayer-float .aplayer-lrc-current {
            color: ' . akina_option('theme_skin') . ' !important
        }

        .linkdes {
            border-top: 1px dotted ' . akina_option('theme_skin') . ' !important
        }

        .the-feature.from_left_and_right .info {
            background: rgba(' . akina_option('hpage-focus-bcr') . ',' . akina_option('hpage-focus-bcg') . ',' . akina_option('hpage-focus-bcb') . ',' . akina_option('hpage-focus-bca') . ')
        }

        .is-active-link::before, .commentbody:not(:placeholder-shown) ~ .input-label, .commentbody:focus ~ .input-label {
            background-color: ' . akina_option('theme_skin') . ' !important
        }

        .links ul li {
            border: 1px solid' . akina_option('theme_skin') . '
        }

        .links ul li img {
            box-shadow: inset 0 0 10px' . akina_option('theme_skin') . '
        }

        .commentbody:focus {
            border-color: ' . akina_option('theme_skin') . ' !important
        }
        ...
        .search_close:after,
        .search_close:before {
            background-color: ' . akina_option('theme_skin') . '
        }
        ...
        .ins-section .ins-section-header {
            color: ' . akina_option('theme_skin') . ';
            border-bottom: 3px solid ' . akina_option('theme_skin') . ';
            border-color: ' . akina_option('theme_skin') . ';
        }
        ...
        .header-info {
            color: ' . akina_option('theme_skin') . ';
            background: rgba(' . akina_option('info-bar-bg-cr') . ',' . akina_option('info-bar-bg-cg') . ', ' . akina_option('info-bar-bg-cb') . ', ' . akina_option('info-bar-bg-ca') . ');
        }
        ...
        .skin-menu {
            background-color: rgba(' . akina_option('fore-switch-bcr') . ', ' . akina_option('fore-switch-bcg') . ', ' . akina_option('fore-switch-bcb') . ', ' . akina_option('fore-switch-bca') . ');
        }
        ...
        .post-more i:hover, #pagination a:hover, .post-content a:hover, .float-content i:hover, .entry-content a:hover, .site-info a:hover, .comment h4 a:hover, .site-top ul li a:hover, .entry-title a:hover, .sorry li a:hover, .site-title a:hover, i.iconfont.js-toggle-search.iconsearch:hover, .comment-respond input[type=\'submit\']:hover {
            color: ' . akina_option('theme_skinm') . '
        }

        .navigator i:hover {
            background: ' . akina_option('theme_skinm') . '
        }

        .navigator i:hover, .links ul li:hover, #pagination a:hover, .comment-respond input[type=\'submit\']:hover {
            border-color: ' . akina_option('theme_skinm') . '
        }

        .insert-image-tips:hover, .insert-image-tips-hover {
            color: ' . akina_option('theme_skinm') . ';
            border: 1px solid ' . akina_option('theme_skinm') . '
        }
        ...
        .ex-register input.register-button:hover {
            background-color: ' . akina_option('theme_skinm') . ';
            border-color: ' . akina_option('theme_skinm') . ';
        }
        ...
        .link-title span.link-fix {
            border-left: 3px solid ' . akina_option('theme_skin') . ';
        }

        .scrollbar, .butterBar-message {
            background: ' . akina_option('theme_skin') . ' !important
        }
        ...
        #nprogress .spinner-icon {
            border-top-color: ' . akina_option('theme_skin') . ';
            border-left-color: ' . akina_option('theme_skin') . ';
        }

        #nprogress .peg {
            box-shadow: 0 0 10px ' . akina_option('theme_skin') . ', 0 0 5px ' . akina_option('theme_skin') . ';
        }
        ...
        background-color: ' . akina_option('theme_skin') . '; /*!important*/ /*mark*/
        }
        ...
        if (akina_option('entry_content_theme') == SAKURA_DOMAIN) {
            $result .= '.entry-content th {
            background-color: ' . akina_option('theme_skin') . '
            }';
        }
        if (akina_option('live_search')) {
            $result .= '.search-form--modal .search-form__inner {
            bottom: unset !important;
            top: 10% !important;
            }';
        }
        $result .= '.post-list-thumb {
        opacity: 0
        }
    ...
    if (akina_option('title-line', '1')):
        $result .= '.single-center header.single-header .toppic-line {
        position: relative;
        bottom: 0;
        left: 0;
        display: block;
    ...
    if (akina_option('title-ani', '1')):
        $result .= '.entry-title, .single-center .entry-census a, .entry-census, .post-list p, .post-more i, .p-time, .feature {
    ...
    if (akina_option('homepage-ani', '1')):
        $result .= 'h1.main-title, h1.fes-title, .the-feature.from_left_and_right .info, .header-info p, .header-info, .focusinfo .header-tou img, .top-social img, .center-text {
    ...
    if (akina_option('feature_align') == 'left') :
        $result .= '.post-list-thumb .post-content-wrap {
        float: left;
        padding-left: 30px;
        padding-right: 0;
        text-align: right;
    ...
    if (akina_option('feature_align') == 'alternate') :
        $result .= '.post-list-thumb:nth-child(2n) .post-content-wrap {
        float: left;
        padding-left: 30px;
        padding-right: 0;
        text-align: right;
