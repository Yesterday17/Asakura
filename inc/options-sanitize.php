...
function of_sanitize_background($input) {
    $output = wp_parse_args($input, array('color'    => '', 'image' => '', 'repeat' => 'repeat',
                                          'position' => 'top center', 'attachment' => 'scroll'
    ));
...
function of_recognized_background_repeat() {
    $default = array('no-repeat' => '不重复填充', 'repeat-x' => '水平重复填充', 'repeat-y' => '垂直重复填充', 'repeat' => '重复填充');
    return apply_filters('of_recognized_background_repeat', $default);
}

function of_recognized_background_position() {
    $default = array('top left'      => '上左对齐', 'top center' => '上中对齐', 'top right' => '上右对齐', 'center left' => '中左对齐',
                     'center center' => '中中对齐', 'center right' => '中右对齐', 'bottom left' => '下左对齐',
                     'bottom center' => '下中对齐', 'bottom right' => '下右对齐'
    );
    return apply_filters('of_recognized_background_position', $default);
}

function of_recognized_background_attachment() {
    $default = array('scroll' => '固定', 'fixed' => '滚动');
...
function of_recognized_font_faces() {
    $default = array('arial'    => 'Arial', 'verdana' => 'Verdana, Geneva', 'trebuchet' => 'Trebuchet',
                     'georgia'  => 'Georgia', 'times' => 'Times New Roman', 'tahoma' => 'Tahoma, Geneva',
                     'palatino' => 'Palatino', 'helvetica' => 'Helvetica*'
    );
    return apply_filters('of_recognized_font_faces', $default);
}

function of_recognized_font_styles() {
    $default = array('normal' => '普通', 'italic' => '斜体', 'bold' => '粗体', 'bold italic' => '斜体+粗体');
